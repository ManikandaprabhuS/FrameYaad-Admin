...
const ProductCatalogCard: React.FC<ProductCatalogCardProps> = ({ product, wished, onToggleWishlist }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3.5">
        <h2 className="truncate text-sm font-extrabold text-black" title={product.name}>{product.name}</h2>
        ...
        <div className="mt-auto flex items-end justify-between gap-2 pt-2">
          ...
          <button
            ...
            className="inline-flex h-8 items-center gap-1.5 rounded-md bg-black px-3 text-[10px] font-bold text-white transition hover:bg-black/80 disabled:cursor-not-allowed disabled:bg-black/25"
          >
